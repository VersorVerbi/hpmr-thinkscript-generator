...
export default async function gatherVariables(args) {
    let vars = {
        filename: null,
        symbol1: '',
        symbol2: '',
    ...
    if (args === null || args === void 0 ? void 0 : args.source) {
        ...
        promptProps.properties.filename = sourceFileProp;
    if ((args === null || args === void 0 ? void 0 : args.generateAll) === undefined) {
        //@ts-ignore
    ...
    if (args === null || args === void 0 ? void 0 : args.symbols) {
    ...
    else if (!(args === null || args === void 0 ? void 0 : args.useStdOut))
        promptProps.properties.outPath = outPathProp;
    let results = await prompt.get(promptProps);
    //@ts-ignore
    if (results.symbols)
        vars.symbol1 = results.symbols.one;
    //@ts-ignore
    if (results.symbols)
        vars.symbol2 = results.symbols.two;
    //@ts-ignore
    if (results.filename)
        vars.filename = results.filename;
    if (results.outPath) {
        //@ts-ignore
